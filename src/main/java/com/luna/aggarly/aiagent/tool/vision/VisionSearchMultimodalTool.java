...
public class VisionSearchMultimodalTool implements Tool<VisionSearchMultimodalTool.Params, List<VisionSearchResult>> {
    ...
    @Override
    public String name() {
        return "vision.searchMultimodal";
    }

    @Override
    public String description() {
        return "Perform combined image + text visual search. Provide a reference image key and text constraints (e.g. 'like this photo but with private pool and in Santorini').";
    }
    ...
    public ToolResult<List<VisionSearchResult>> execute(Params params, UserPrincipal currentUser) {
        log.info("Executing tool vision.searchMultimodal with imageKey: {}, text: {}", params.referenceObjectKey(), params.textQuery());
